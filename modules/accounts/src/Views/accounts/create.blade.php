        ...
        <div class="panel-body">
            <form class="form-horizontal" method="POST" action="{{ route('accounts.store') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input id="short_name" name="short_name" type="text" class="form-control" value="{{ old('short_name') }}" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input id="cnpj_cpf" name="cnpj_cpf" type="text" class="form-control" value="{{ old('cnpj_cpf') }}" >
                    </div>
                </div>
